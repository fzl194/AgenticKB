...
08-S0/S1（P13 鉴权）✅ · 06-S1（P07 启动自愈）✅ · 06-S2（P07 租约）✅ · 03-S1（P03 冻结输入）✅ · 05-P06（幽灵路由退役）✅ · 02-S1（质量基准+落库）✅ · 02-S2（质量档位）✅ · 02-S3（fallback 链）✅ · **批次4 检索就绪（P04）✅**（units/embeddings 入库栅栏修复+按能力验收门禁+readiness 四档+建库默认 full-baseline；报告 `15-批次4-检索就绪-测试报告-2026-08-28.md`）
