"""Admin endpoints — config hot-reload + retention cleanup."""
...
def _build_provider(active_provider: dict) -> tuple[object, str]:
    ...
    return build_chat_provider(active_provider)
...
async def reload_config(request: Request):
    ...
    # ── 10. Refresh internal verify secret (auth.yaml may have rotated) ──
